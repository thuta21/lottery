...
import { Trophy, Ticket, List } from "lucide-react";
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <div className="hidden md:flex items-center space-x-6">
              ...
              <Link href="/results">
                <div className="flex items-center space-x-2 bg-green-600/80 px-4 py-2 rounded-full backdrop-blur-sm">
                  <List className="w-5 h-5" />
                  <span className="font-medium">{t('results', language)}</span>
                </div>
              </Link>
            </div>
            <LanguageToggle 
